...
// Takes in a postData object
// [{post},]
export function tagCounts(postsData){
    var tagCounts = {}
...
// Takes in a postDataContent object
// [{data:{}, content;""},]
export function tagCountsContent(postDataContent) {
    var tagCounts = {}
    postDataContent.forEach(post => {
